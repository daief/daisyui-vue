...
</code></pre>`,2),O={setup(a,{expose:n}){return n({frontmatter:{meta:[]}}),f({meta:[]}),(h,i)=>{const r=C,e=p("Playground"),u=I,x=k,d=p("MarkdownTable");return o(),y("div",z,[T,B,A,s(e,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
...
`},{default:c(()=>[s(x)]),_:1}),F,M,s(d,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"columns","1":"table columns config","2":"ITableColumn[]","3":"-"},{"0":"dataSource","1":"table data source","2":"array","3":"-"},{"0":"compact","1":"makes table more compact","2":"boolean","3":"-"},{"0":"zebra","1":"makes table rows zebra","2":"boolean","3":"-"}]}),P])}}};export{O as default};
