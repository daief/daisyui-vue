import{e as r,w as j,c as s,y as a,a as e,u as g,z as m,A as i,F as u,B as c,C as v}from"./vendor.5c279da4.js";var w={setup:()=>{const n=r({show:!1});let t=0;j([()=>t],(l,o)=>{console.log(l,o)});const p=()=>n.show=!1;return()=>s("div",{class:"text-center"},[s(a("dv-toggle"),{checked:n.show,onChange:l=>n.show=l.target.checked},null),s("hr",null,null),s(a("dv-modal-base"),{open:n.show,onClose:p,destroyOnClose:!0},{default:()=>[s(a("dv-modal-title"),{onClose:p},{default:()=>[e("1")]}),s(a("dv-modal-body"),null,{default:()=>[e("2332")]}),s(a("dv-modal-action"),null,{default:()=>[s(a("dv-button"),null,{default:()=>[e("Yay!")]})]})]})])}};const f=c("div",{class:"markdown-body"},[c("h1",null,"Demo for development")],-1),y=c("div",{class:"markdown-body"},null,-1),k=[],b={setup(n,{expose:t}){return t({frontmatter:{meta:[]}}),g({meta:[]}),(o,_)=>{const h=w,d=a("Playground");return v(),m(u,null,[f,s(d,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { reactive, watch } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
