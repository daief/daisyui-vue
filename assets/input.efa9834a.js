...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[s("div",F,[a(l,{class:"w-full max-w-xs",placeholder:"disabled",disabled:""})])]),_:1}),s("div",M,[N,P,a(e,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"type","1":"input color type","2":"netural, primary, secondary, accent, info, success, warning, error, ghost","3":"netural"},{"0":"size","1":"input size","2":"ISize","3":"md"},{"0":"border","1":"input border","2":"boolean","3":"true"}]})])],64)}}};export{K as default,J as meta};
