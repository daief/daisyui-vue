import{v as m,c as s,a0 as l,a as t,Q as x,u as w,a2 as y,a3 as a,p as q,a4 as n,a5 as k}from"./vendor.5f72a9a7.js";function C(e){return typeof e=="function"||Object.prototype.toString.call(e)==="[object Object]"&&!x(e)}var I={setup:()=>{const e=["top-start","top","top-end","bottom-start","bottom","bottom-end","left-start","left","left-end","right-start","right","right-end"],c=m(e[0]),h=m("btn"),o=r=>e.slice(r,r+3).map(p=>s(l("dv-button"),{key:p,size:"xs","data-pls":p,onClick:()=>c.value=p,type:p===c.value?"primary":"netural"},C(p)?p:{default:()=>[p]}));return()=>s("div",{class:"w-full"},[s("div",{class:"flex justify-center space-x-3 mb-1"},[s(l("dv-button"),{onClick:()=>h.value="btn"},{default:()=>[t("button")]}),s(l("dv-button"),{onClick:()=>h.value="div"},{default:()=>[t("div")]})]),s(l("dv-divider"),null,null),s("div",{class:"h-80 relative flex items-center justify-center"},[s(l("dv-dropdown"),{content:()=>s(l("dv-menu"),{class:"shadow-lg rounded-lg bg-base-100 p-1 w-40"},{default:()=>[s(l("dv-menu-item"),null,{default:()=>[t("Item 1")]}),s(l("dv-menu-item"),null,{default:()=>[t("Item 2")]})]}),open:!0,placement:c.value},{default:()=>[h.value==="btn"?s(l("dv-button"),{size:"sm"},{default:()=>[t("button")]}):s("div",{class:"w-8 h-8 flex items-center justify-center bg-red-400"},[t("div")])]}),s("div",{class:"absolute top-0 w-full flex justify-center space-x-2"},[o(0)]),s("div",{class:"absolute right-0 h-full flex flex-col justify-center space-y-2"},[o(9)]),s("div",{class:"absolute bottom-0 w-full flex justify-center space-x-2"},[o(3)]),s("div",{class:"absolute left-0 h-full flex flex-col justify-center space-y-2"},[o(6)])])])}};const S=n("div",{class:"markdown-body"},[n("h1",null,"Dropdown"),n("h2",null,"Examples"),n("p",null,"Dropdown menu")],-1),T={class:"text-center"},z=t("Click"),A=t("Item 1"),H=t("Item 2"),D=n("div",{class:"markdown-body"},[n("p",null,"Hover")],-1),N={class:"text-center"},V=t("Hover"),B=t("Item 1"),P=t("Item 2"),E=n("div",{class:"markdown-body"},[n("p",null,"placement")],-1),O=n("div",{class:"markdown-body"},[n("p",null,"Dropdown card")],-1),F={class:"text-center"},Q=t("Hover"),G=t("Card Title"),J=n("p",null," you can use any element as a dropdown. ",-1),K=n("div",{class:"markdown-body"},[n("h2",null,"Dropdown"),n("h3",null,"Attributes"),n("p",null,[t("Attributes are same as "),n("code",null,"Popper"),t(".")])],-1),M=[],R={setup(e,{expose:c}){return c({frontmatter:{meta:[]}}),w({meta:[]}),(r,p)=>{const g=l("dv-button"),d=l("dv-menu-item"),i=l("dv-menu"),u=l("dv-dropdown"),j=l("Playground"),v=I,f=l("dv-card-title"),_=l("dv-card-body"),b=l("dv-card");return k(),y(q,null,[S,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text-center&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-dropdown</span> <span class="hljs-attr">triggerAction</span>=<span class="hljs-string">&quot;click&quot;</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> #<span class="hljs-attr">content</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">dv-menu</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;shadow-lg rounded-lg bg-base-100 p-2 w-56&quot;</span>&gt;</span>
...
`},{default:a(()=>[n("div",T,[s(u,{triggerAction:"click"},{content:a(()=>[s(i,{class:"shadow-lg rounded-lg bg-base-100 p-2 w-56"},{default:a(()=>[s(d,null,{default:a(()=>[A]),_:1}),s(d,null,{default:a(()=>[H]),_:1})]),_:1})]),default:a(()=>[s(g,null,{default:a(()=>[z]),_:1})]),_:1})])]),_:1}),D,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text-center&quot;</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-dropdown</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:a(()=>[n("div",N,[s(u,{triggerAction:"hover"},{content:a(()=>[s(i,{class:"shadow-lg rounded-lg bg-base-100 p-2 w-56"},{default:a(()=>[s(d,null,{default:a(()=>[B]),_:1}),s(d,null,{default:a(()=>[P]),_:1})]),_:1})]),default:a(()=>[s(g,null,{default:a(()=>[V]),_:1})]),_:1})])]),_:1}),E,s(j,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
        ...
        <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;h-80 relative flex items-center justify-center&quot;</span>&gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">dv-dropdown</span>
            <span class="hljs-attr">content</span>=<span class="hljs-string">{()</span> =&gt;</span> (
              <span class="hljs-tag">&lt;<span class="hljs-name">dv-menu</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;shadow-lg rounded-lg bg-base-100 p-1 w-40&quot;</span>&gt;</span>
                <span class="hljs-tag">&lt;<span class="hljs-name">dv-menu-item</span>&gt;</span>Item 1<span class="hljs-tag">&lt;/<span class="hljs-name">dv-menu-item</span>&gt;</span>
                <span class="hljs-tag">&lt;<span class="hljs-name">dv-menu-item</span>&gt;</span>Item 2<span class="hljs-tag">&lt;/<span class="hljs-name">dv-menu-item</span>&gt;</span>
              <span class="hljs-tag">&lt;/<span class="hljs-name">dv-menu</span>&gt;</span>
            )}
...
`},{default:a(()=>[s(v)]),_:1}),O,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text-center&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-dropdown</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">dv-button</span>&gt;</span>Hover<span class="hljs-tag">&lt;/<span class="hljs-name">dv-button</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> #<span class="hljs-attr">content</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">dv-card</span> <span class="hljs-attr">bordered</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;w-64 bg-base-100&quot;</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-dropdown</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:a(()=>[n("div",F,[s(u,null,{content:a(()=>[s(b,{bordered:"",class:"w-64 bg-base-100"},{default:a(()=>[s(_,null,{default:a(()=>[s(f,null,{default:a(()=>[G]),_:1}),J]),_:1})]),_:1})]),default:a(()=>[s(g,null,{default:a(()=>[Q]),_:1})]),_:1})])]),_:1}),K],64)}}};export{R as default,M as meta};
