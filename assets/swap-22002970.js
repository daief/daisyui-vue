...
`},{default:t(()=>[s(r)]),_:1}),I,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-swap</span> <span class="hljs-attr">animation</span>=<span class="hljs-string">&quot;rotate&quot;</span>&gt;</span>
...
`},{default:t(()=>[s(o,{animation:"rotate"},{on:t(()=>[s(u,{size:"48px"})]),off:t(()=>[s(i,{size:"48px"})]),_:1})]),_:1}),z,s(l,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
    <span class="hljs-keyword">return</span> <span class="hljs-function">() =&gt;</span> (
...
`},{default:t(()=>[s(j)]),_:1}),a("div",S,[F,M,s(c,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{0:"on",1:"render on",2:"-",3:"-"},{0:"off",1:"render off",2:"-",3:"-"},{0:"tag",1:"wrap elemnt tag",2:"string",3:"label"},{0:"animation",1:"animation effect",2:"rotate, flip",3:"-"},{0:"active",1:"swap active status",2:"boolean",3:"-"},{0:"onChange",1:"swap active status change event",2:"Function",3:"-"}]}),V,s(c,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1}],dataSource:[{0:"on",1:"render on"},{0:"off",1:"render off"}]})])],64)}}},P=m(N,[["__file","/home/runner/work/daisyui-vue/daisyui-vue/docs/src/pages/components/swap.md"]]);export{P as default,E as meta};
