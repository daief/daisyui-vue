import{u as b,K as f,a5 as p,a7 as q,c as s,a8 as a,a9 as n,F as w,ab as y,aa as x,a as l}from"./vendor.284b0716.js";const k=y(`<div class="markdown-body"><h1>Drawer</h1><h2>Examples</h2><pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">setup</span> <span class="hljs-attr">lang</span>=<span class="hljs-string">&quot;ts&quot;</span>&gt;</span><span class="language-javascript">
...
&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-drawer</span>&gt;</span>
`},{default:a(()=>[s(i,{open:h("d3"),disableTeleport:"",mobileOnly:"",onClose:o,class:"rounded-lg shadow bg-base-200 h-52"},{default:a(()=>[n("div",A,[s(e,{class:"px-4"},{default:a(()=>[s(t,null,{default:a(()=>[H]),_:1}),s(t,null,{default:a(()=>[K]),_:1}),s(t,null,{default:a(()=>[G]),_:1})]),_:1})])]),content:a(()=>[n("div",J,[L,n("div",Q,[U,s(d,{onClick:()=>c("d3"),type:"primary"},{default:a(()=>[W]),_:1},8,["onClick"])])])]),_:1},8,["open"])]),_:1}),X,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-drawer</span>
