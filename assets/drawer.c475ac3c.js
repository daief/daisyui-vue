...
`},{default:o(()=>[s(j)]),_:1}),O,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
    <span class="hljs-keyword">const</span> isOpen = <span class="hljs-title function_">ref</span>(<span class="hljs-literal">false</span>);
    <span class="hljs-keyword">const</span> <span class="hljs-title function_">toggle</span> = (<span class="hljs-params"></span>) =&gt; (isOpen.<span class="hljs-property">value</span> = !isOpen.<span class="hljs-property">value</span>);
...
`},{default:o(()=>[s(g)]),_:1}),M,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref, computed } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:o(()=>[s(m)]),_:1}),I,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref, computed } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
<span class="hljs-keyword">import</span> { useBreakPointLte } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;daisyui-vue&#x27;</span>;
...
`},{default:o(()=>[s(v)]),_:1}),T,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref, computed } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
<span class="hljs-keyword">import</span> { useBreakPointLte } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;daisyui-vue&#x27;</span>;
...
`},{default:o(()=>[s(f)]),_:1}),t("div",B,[P,L,s(u,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{0:"open",1:"drawer open/close status",2:"boolean",3:"-"},{0:"disableTeleport",1:"disable teleport behavior",2:"boolean",3:"-"},{0:"flattern",1:"make drawer to be always visible",2:"boolean",3:"-"},{0:"placement",1:"drawer open position",2:"left, right",3:"left"},{0:"placement",1:"drawer open position",2:"left, right",3:"left"}]}),R,s(u,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{0:"close",1:"drawer close event",2:"function",3:"-"}]}),S,s(u,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1}],dataSource:[{0:"default",1:"drawer side content"},{0:"content",1:"drawer content"}]})])],64)}}};export{F as default,D as meta};
