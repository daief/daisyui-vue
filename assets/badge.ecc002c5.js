import{u as g,Y as e,_ as j,$ as i,c as s,a0 as a,a1 as t,n as r,a as n}from"./vendor.1d9a2266.js";const m=t("div",{class:"markdown-body"},[t("h1",null,"Badge"),t("h2",null,"Examples"),t("p",null,"badge")],-1),u={class:"flex flex-wrap items-start md:space-x-2 space-y-2 md:space-y-0 flex-col md:flex-row"},_=n("netural"),b=n("primary"),f=n("secondary"),q=n("accent"),v=n("ghost"),x=n("info"),y=n("success"),w=n("warning"),z=n("error"),N=t("div",{class:"markdown-body"},[t("p",null,"badge size")],-1),k={class:"flex flex-wrap items-start md:space-x-2 space-y-2 md:space-y-0 flex-col md:flex-row"},H=n("987,654"),I=n("987,654"),B=n("987,654"),V=n("987,654"),A=t("div",{class:"markdown-body"},[t("p",null,"empty badge")],-1),T={class:"flex flex-wrap items-start md:space-x-2 space-y-2 md:space-y-0 flex-col md:flex-row"},C=t("div",{class:"markdown-body"},[t("p",null,"badge variants")],-1),E={class:"flex flex-wrap items-start md:space-x-2 space-y-2 md:space-y-0 flex-col md:flex-row"},M=n(" primary "),P=n(" info "),S=n(" warning "),F=n(" error "),Y=t("div",{class:"markdown-body"},[t("p",null,"badge outline")],-1),$={class:"flex flex-wrap items-start md:space-x-2 space-y-2 md:space-y-0 flex-col md:flex-row"},D=n("netural"),G=n("primary"),J=n("secondary"),K=n("accent"),L=t("div",{class:"markdown-body"},[t("p",null,"badge in text")],-1),O={class:"mb-2 text-2xl"},Q=n(" Heading "),R=n("New"),U={class:"mb-2 text-xl"},W=n(" Heading "),X=n("New"),Z={class:"mb-2 text-lg"},ss=n(" Heading "),as=n("New"),ns={class:"mb-2 text-md"},ls=n(" Heading "),ts=n("New"),ps={class:"text-sm"},es=n(" Heading "),cs=n("New"),os=t("div",{class:"markdown-body"},[t("p",null,"badge in button")],-1),hs={class:"flex flex-wrap items-start md:space-x-2 space-x-0 space-y-2 md:space-y-0 flex-col md:flex-row"},ds=n(" Version 2.7.0 "),gs=n("new"),js=n(" Inbox "),is=n("3"),rs=n(" Notifications "),ms=n("+999"),us=n(" Accent "),_s=n("new"),bs={class:"markdown-body"},fs=t("h2",null,"Badge",-1),qs=t("h3",null,"Attributes",-1),ks=[],Hs={setup(vs,{expose:h}){return h({frontmatter:{meta:[]}}),g({meta:[]}),(ws,zs)=>{const l=e("dv-badge"),p=e("Playground"),c=e("icon-close"),o=e("dv-button"),d=e("MarkdownTable");return j(),i(r,null,[m,s(p,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>
...
`},{default:a(()=>[t("div",u,[s(l,null,{default:a(()=>[_]),_:1}),s(l,{type:"primary"},{default:a(()=>[b]),_:1}),s(l,{type:"secondary"},{default:a(()=>[f]),_:1}),s(l,{type:"accent"},{default:a(()=>[q]),_:1}),s(l,{type:"ghost"},{default:a(()=>[v]),_:1}),s(l,{type:"info"},{default:a(()=>[x]),_:1}),s(l,{type:"success"},{default:a(()=>[y]),_:1}),s(l,{type:"warning"},{default:a(()=>[w]),_:1}),s(l,{type:"error"},{default:a(()=>[z]),_:1})])]),_:1}),N,s(p,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>
  <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;flex flex-wrap items-start md:space-x-2 space-y-2 md:space-y-0 flex-col md:flex-row&quot;</span>
&gt;</span>
...
&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-badge</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:a(()=>[t("div",E,[s(l,{type:"primary"},{default:a(()=>[s(c,{size:"14px",class:"mr-1"}),M]),_:1}),s(l,{type:"info"},{default:a(()=>[s(c,{size:"14px",class:"mr-1"}),P]),_:1}),s(l,{type:"warning"},{default:a(()=>[s(c,{size:"14px",class:"mr-1"}),S]),_:1}),s(l,{type:"error"},{default:a(()=>[s(c,{size:"14px",class:"mr-1"}),F]),_:1})])]),_:1}),Y,s(p,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>
  <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;flex flex-wrap items-start md:space-x-2 space-y-2 md:space-y-0 flex-col md:flex-row&quot;</span>
&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:a(()=>[t("div",$,[s(l,{outline:""},{default:a(()=>[D]),_:1}),s(l,{outline:"",type:"primary"},{default:a(()=>[G]),_:1}),s(l,{outline:"",type:"secondary"},{default:a(()=>[J]),_:1}),s(l,{outline:"",type:"accent"},{default:a(()=>[K]),_:1})])]),_:1}),L,s(p,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">h2</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:a(()=>[t("div",null,[t("h2",O,[Q,s(l,{outline:"",size:"lg"},{default:a(()=>[R]),_:1})]),t("h2",U,[W,s(l,{outline:"",size:"md"},{default:a(()=>[X]),_:1})]),t("h2",Z,[ss,s(l,{outline:"",size:"md"},{default:a(()=>[as]),_:1})]),t("h2",ns,[ls,s(l,{outline:"",size:"sm"},{default:a(()=>[ts]),_:1})]),t("h2",ps,[es,s(l,{outline:"",size:"sm"},{default:a(()=>[cs]),_:1})])])]),_:1}),os,s(p,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>
...
&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-button</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:a(()=>[t("div",hs,[s(o,null,{default:a(()=>[ds,s(l,{class:"ml-2"},{default:a(()=>[gs]),_:1})]),_:1}),s(o,{type:"primary"},{default:a(()=>[js,s(l,{class:"ml-2",outline:""},{default:a(()=>[is]),_:1})]),_:1}),s(o,{type:"secondary"},{default:a(()=>[rs,s(l,{class:"ml-2",outline:""},{default:a(()=>[ms]),_:1})]),_:1}),s(o,{type:"accent"},{default:a(()=>[us,s(l,{class:"ml-2",outline:""},{default:a(()=>[_s]),_:1})]),_:1})])]),_:1}),t("div",bs,[fs,qs,s(d,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"type","1":"color type","2":"netural, primary, secondary, accent, info, success, warning, error, ghost, link, glass","3":"netural"},{"0":"size","1":"size","2":"ISize","3":"md"},{"0":"outline","1":"transparent badge with [colorful] border","2":"boolean","3":"false"}]})])],64)}}};export{Hs as default,ks as meta};
