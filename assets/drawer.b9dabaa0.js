import{u as b,j as f,z as p,A as q,c as s,B as a,C as n,F as w,G as y,D as x,a as l}from"./vendor.6a4aa954.js";const k=y(`<div class="markdown-body"><h1>Drawer</h1><h2>Examples</h2><pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">setup</span> <span class="hljs-attr">lang</span>=<span class="hljs-string">&quot;ts&quot;</span>&gt;</span><span class="language-javascript">
...
&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-drawer</span>&gt;</span>
`},{default:a(()=>[s(i,{open:h("d3"),disableTeleport:"",mobileOnly:"",onClose:o,class:"rounded-lg shadow bg-base-200 h-52"},{default:a(()=>[n("div",F,[s(e,{class:"px-4"},{default:a(()=>[s(t,null,{default:a(()=>[P]),_:1}),s(t,null,{default:a(()=>[G]),_:1}),s(t,null,{default:a(()=>[H]),_:1})]),_:1})])]),content:a(()=>[n("div",J,[K,n("div",L,[Q,s(d,{onClick:()=>c("d3"),type:"primary"},{default:a(()=>[U]),_:1},8,["onClick"])])])]),_:1},8,["open"])]),_:1}),W,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-drawer</span>
