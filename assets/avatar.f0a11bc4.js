import{u as o,l as c,o as r,c as s,q as t,F as e,s as n,x as h}from"./vendor.be1ef881.js";const g=n("div",{class:"markdown-body"},[n("h1",null,"Avatar"),n("h2",null,"Examples"),n("p",null,"avatar")],-1),u={class:"flex items-center space-x-8 flex-wrap"},j=n("div",{class:"markdown-body"},[n("p",null,"avatar with mask")],-1),d={class:"flex items-center space-x-8 flex-wrap"},m=n("div",{class:"markdown-body"},[n("p",null,"avatar with border(by css). Circle & square types only, but the others are not supported")],-1),q={class:"flex items-center space-x-8 flex-wrap mb-8"},w={class:"flex items-center space-x-8 flex-wrap"},f=n("div",{class:"markdown-body"},[n("p",null,"avatar-group, default gap(half size)")],-1),v=n("div",{class:"markdown-body"},[n("p",null,"avatar-group, custom gap")],-1),y=n("span",{class:"text-xl"},"+99",-1),x=n("div",{class:"markdown-body"},[n("p",null,"avatar with presense indicator")],-1),_={class:"flex items-center space-x-8 flex-wrap mb-4"},z={class:"flex items-center space-x-8 flex-wrap"},b=n("div",{class:"markdown-body"},[n("p",null,"avatar placeholder")],-1),k={class:"flex items-center space-x-8 flex-wrap"},A=n("span",{class:"text-2xl"},"+99",-1),B=n("span",{class:"text-xs"},"AA",-1),C=n("div",{class:"markdown-body"},[n("h2",null,"Avatar"),n("h3",null,"Attributes"),n("h2",null,"AvatarGroup"),n("h3",null,"Attributes")],-1),P={setup(E,{expose:i}){return i({frontmatter:{meta:[]}}),o({meta:[]}),(M,N)=>{const a=c("dv-avatar"),l=c("Playground"),p=c("dv-avatar-group");return h(),r(e,null,[g,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;flex items-center space-x-8 flex-wrap&quot;</span>&gt;</span>
...
`},{default:t(()=>[n("div",u,[s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"96px"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"lg"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"md"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"sm"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"xs"})])]),_:1}),j,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;flex items-center space-x-8 flex-wrap&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-avatar</span>
    <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;http://daisyui.com/tailwind-css-component-profile-1@94w.png&quot;</span>
  ...
  /&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[n("div",d,[s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",type:"circle",size:"lg"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",type:"squircle",size:"lg"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",type:"hexagon",size:"lg"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",type:"decagon",size:"lg"})])]),_:1}),m,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;flex items-center space-x-8 flex-wrap mb-8&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-avatar</span>
    <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;http://daisyui.com/tailwind-css-component-profile-1@94w.png&quot;</span>
    <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;lg&quot;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-avatar-group</span>&gt;</span>
`},{default:t(()=>[s(p,{size:"80px",gap:50},{default:t(()=>[s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png"}),s(a,{placeholder:""},{default:t(()=>[y]),_:1})]),_:1})]),_:1}),x,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;flex items-center space-x-8 flex-wrap mb-4&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-avatar</span>
    <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;http://daisyui.com/tailwind-css-component-profile-1@94w.png&quot;</span>
    <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;lg&quot;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;flex items-center space-x-8 flex-wrap&quot;</span>&gt;</span>
  ...
  /&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[n("div",_,[s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"lg",status:"online"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"md",status:"online"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"sm",status:"offline"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"xs",status:"offline"})]),n("div",z,[s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"lg",status:"offline",type:"squircle"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"md",status:"offline",type:"squircle"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"sm",status:"online",type:"squircle"}),s(a,{src:"http://daisyui.com/tailwind-css-component-profile-1@94w.png",size:"xs",status:"online",type:"squircle"})])]),_:1}),b,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;flex items-center space-x-8 flex-wrap&quot;</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-avatar</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[n("div",k,[s(a,{size:"lg",status:"offline",type:"squircle",placeholder:""},{default:t(()=>[A]),_:1}),s(a,{size:"md",status:"offline",placeholder:"JO"}),s(a,{size:"sm",placeholder:"MX"}),s(a,{size:"xs",placeholder:"",type:"circle"},{default:t(()=>[B]),_:1})])]),_:1}),C],64)}}};export{P as default};
