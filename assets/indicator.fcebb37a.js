import{B as q}from"./app.42068e1e.js";import{c as s,a5 as t,a as p,u as x,a7 as w,a8 as a,a9 as n,F as k,aa as I}from"./vendor.284b0716.js";var T={setup:()=>{const g="top-middle-bottom".split("-"),i="start-center-end".split("-"),h=[];return g.forEach(d=>{i.forEach(j=>{h.push(d+"-"+j)})}),()=>s(t("dv-indicator"),null,{default:()=>[h.map(d=>s(t("dv-indicator-item"),{key:d,placement:d,tag:q,type:"secondary"},{default:()=>[d]})),s("div",{class:"grid w-80 h-32 bg-base-300 place-items-center"},[p("content")])]})}};const B=n("div",{class:"markdown-body"},[n("h1",null,"Indicator"),n("h2",null,"Examples"),n("p",null,"Empty badge as indicator")],-1),E=n("div",{class:"grid w-32 h-32 bg-base-300 place-items-center"}," content ",-1),N=n("div",{class:"markdown-body"},[n("p",null,"Badge as indicator")],-1),z=p("New"),A=n("div",{class:"grid w-32 h-32 bg-base-300 place-items-center"}," content ",-1),V=n("div",{class:"markdown-body"},[n("p",null,"for button")],-1),C=p("99+"),R=p("INBOX"),F=n("div",{class:"markdown-body"},[n("p",null,"for avatar")],-1),J=p("Typing..."),M=n("div",{class:"markdown-body"},[n("p",null,"for tab")],-1),O=p("1"),P=n("a",null,"Tiny 1",-1),S=n("div",{class:"markdown-body"},[n("p",null,"for an input")],-1),X=p("Required"),Y=n("div",{class:"markdown-body"},[n("p",null,"A button as an indicator for a card")],-1),H=p("Apply"),D=n("div",{class:"markdown-body"},[n("p",null,"multiple indicators")],-1),G={class:"markdown-body"},K=n("h2",null,"Indicator",-1),L=n("h3",null,"Attributes",-1),Q=n("h2",null,"IndicatorItem",-1),U=n("h3",null,"Attributes",-1),ss=[],as={setup(g,{expose:i}){return i({frontmatter:{meta:[]}}),x({meta:[]}),(j,W)=>{const o=t("dv-badge"),e=t("dv-indicator-item"),c=t("dv-indicator"),l=t("Playground"),m=t("dv-button"),_=t("dv-avatar"),r=t("dv-tab-panel"),v=t("dv-tabs"),b=t("dv-input"),y=t("dv-card"),f=T,u=t("MarkdownTable");return I(),w(k,null,[B,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator</span>&gt;</span>
...
`},{default:a(()=>[s(c,null,{default:a(()=>[s(e,null,{default:a(()=>[s(o,{type:"secondary"})]),_:1}),E]),_:1})]),_:1}),N,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator-item</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;grid w-32 h-32 bg-base-300 place-items-center&quot;</span>&gt;</span> content <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-indicator</span>&gt;</span>
`},{default:a(()=>[s(c,null,{default:a(()=>[s(e,null,{default:a(()=>[s(o,{type:"primary"},{default:a(()=>[z]),_:1})]),_:1}),A]),_:1})]),_:1}),V,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator-item</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-indicator</span>&gt;</span>
`},{default:a(()=>[s(c,null,{default:a(()=>[s(e,null,{default:a(()=>[s(o,{type:"secondary"},{default:a(()=>[C]),_:1})]),_:1}),s(m,null,{default:a(()=>[R]),_:1})]),_:1})]),_:1}),F,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator-item</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-indicator</span>&gt;</span>
`},{default:a(()=>[s(c,null,{default:a(()=>[s(e,null,{default:a(()=>[s(o,{type:"secondary"},{default:a(()=>[J]),_:1})]),_:1}),s(_,{src:"https://placeimg.com/160/160/people",size:80})]),_:1})]),_:1}),M,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-tabs</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;lifted&quot;</span> <span class="hljs-attr">modelValue</span>=<span class="hljs-string">&quot;1&quot;</span>&gt;</span>
...
`},{default:a(()=>[s(v,{type:"lifted",modelValue:"1"},{default:a(()=>[s(r,{name:"1"},{title:a(()=>[s(c,null,{default:a(()=>[s(e,null,{default:a(()=>[s(o,{type:"secondary"},{default:a(()=>[O]),_:1})]),_:1}),P]),_:1})]),_:1}),s(r,{name:"2",title:"Tiny2"}),s(r,{name:"3",title:"Tiny3"})]),_:1})]),_:1}),S,s(l,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-indicator-item</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-indicator</span>&gt;</span>
`},{default:a(()=>[s(c,null,{default:a(()=>[s(e,{placement:"bottom-end"},{default:a(()=>[s(m,{type:"primary"},{default:a(()=>[H]),_:1})]),_:1}),s(y,{class:"bg-base-100",bordered:"",title:"Job Title",description:"Rerum reiciendis beatae tenetur excepturi"})]),_:1})]),_:1}),D,s(l,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { <span class="hljs-title class_">Badge</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;daisyui-vue&#x27;</span>;
...
`},{default:a(()=>[s(f)]),_:1}),n("div",G,[K,L,s(u,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"tag","1":"render element","2":"string, object","3":"div"}]}),Q,U,s(u,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"tag","1":"render element","2":"string, object","3":"div"},{"0":"placement","1":"indicator position","2":"top-start, top-center, top-end, middle-start, middle-center, middle-end, bottom-start, bottom-center, bottom-end","3":"top-end"}]})])],64)}}};export{as as default,ss as meta};
