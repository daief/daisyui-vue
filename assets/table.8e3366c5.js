...
</code></pre>`,2),D={setup(n,{expose:l}){return l({frontmatter:{meta:[]}}),f({meta:[]}),(i,u)=>{const r=C,c=p("Playground"),x=I,d=k,m=p("MarkdownTable");return o(),y(j,null,[z,s(c,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
