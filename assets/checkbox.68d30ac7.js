import{v as r,c as s,a0 as e,Q as v,a as p,u as k,a2 as _,a3 as t,a4 as a,p as b,a5 as y}from"./vendor.d0ebca45.js";var f={setup:()=>{const l=r(!1),n=h=>{l.value=h.target.checked,console.log("Checked:",l.value)};return()=>s(e("dv-checkbox"),{checked:l.value,onChange:n},null)}};function w(l){return typeof l=="function"||Object.prototype.toString.call(l)==="[object Object]"&&!v(l)}var C={setup:()=>{const l=["netural","primary","secondary","accent"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[l.map(n=>s("div",{key:n,class:"w-32"},[s(e("dv-checkbox"),{type:n,defaultChecked:!0},w(n)?n:{default:()=>[n]})]))])}},z={setup:()=>{const l=["xs","sm","md","lg"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[l.map(n=>s("div",{key:n},[s(e("dv-checkbox"),{size:n,defaultChecked:!0},null)]))])}},q={setup:()=>{const l=[{value:"apple",label:"Apple"},{value:"pear",label:"Pear"},{value:"orange",label:"Orange"}],n=r(["apple","pear"]),h=r(!1),i=d=>{n.value=d};return()=>s("div",null,[s("div",{class:"flex items-center"},[s("label",{class:"mr-4"},[p("Disabled:")]),s(e("dv-toggle"),{checked:h.value,onChange:d=>h.value=d.target.checked},null)]),s(e("dv-divider"),null,null),s(e("dv-checkbox-group"),{size:"lg",options:l,disabled:h.value,value:n.value,onChange:i},null)])}};const O=a("div",{class:"markdown-body"},[a("h1",null,"Checkbox"),a("h2",null,"Examples"),a("p",null,"Checkbox")],-1),A=a("div",{class:"markdown-body"},[a("p",null,"With label")],-1),I=p("Orange"),S=p(),P=p("Apple"),N=a("div",{class:"markdown-body"},[a("p",null,"Color type")],-1),V=a("div",{class:"markdown-body"},[a("p",null,"Sizes")],-1),B=a("div",{class:"markdown-body"},[a("p",null,"Disabled")],-1),D=p("Orange"),T=p("Apple"),E=a("div",{class:"markdown-body"},[a("p",null,"Indeterminate(style only, do not affect the value)")],-1),F=p("Orange"),M=p("Apple"),G=p("Pear"),H=a("div",{class:"markdown-body"},[a("p",null,"Group")],-1),Q={class:"markdown-body"},W=a("h2",null,"Checkbox",-1),J=a("h3",null,"Attributes",-1),K=a("h2",null,"CSS variables",-1),U=[],X={setup(l,{expose:n}){return n({frontmatter:{meta:[]}}),k({meta:[]}),(d,L)=>{const u=f,c=e("Playground"),o=e("dv-checkbox"),g=C,x=z,m=q,j=e("MarkdownTable");return y(),_(b,null,[O,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:t(()=>[s(u)]),_:1}),A,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span> <span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span>&gt;</span>Apple<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
`},{default:t(()=>[s(o,null,{default:t(()=>[I]),_:1}),S,s(o,null,{default:t(()=>[P]),_:1})]),_:1}),N,s(c,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
...
`},{default:t(()=>[s(x)]),_:1}),B,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span> <span class="hljs-attr">disabled</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
...
`},{default:t(()=>[s(o,{disabled:""},{default:t(()=>[D]),_:1}),s(o,{defaultChecked:"",disabled:""},{default:t(()=>[T]),_:1})]),_:1}),E,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span> <span class="hljs-attr">indeterminate</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
...
`},{default:t(()=>[s(o,{indeterminate:""},{default:t(()=>[F]),_:1}),s(o,{indeterminate:"",defaultChecked:""},{default:t(()=>[M]),_:1}),s(o,{indeterminate:"",disabled:""},{default:t(()=>[G]),_:1})]),_:1}),H,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:t(()=>[s(m)]),_:1}),a("div",Q,[W,J,s(j,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"size","1":"size","2":"ISize","3":"md"},{"0":"type","1":"color type","2":"netural, primary, secondary, accent","3":"netural"},{"0":"defaultChecked","1":"initial checked status","2":"bool","3":"-"},{"0":"checked","1":"checked status","2":"bool","3":"-"},{"0":"onChange","1":"change callback","2":"Function","3":"-"},{"0":"disabled","1":"disable status","2":"bool","3":"-"},{"0":"readOnly","1":"read only status","2":"bool","3":"-"},{"0":"indeterminate","1":"indeterminate status. style only, do not affect the value","2":"bool","3":"-"}]},null,8,["dataSource"]),K,s(j,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"default",dataIndex:2}],dataSource:[{"0":"--dv-checkbox-gap","1":"checkbox horizontal gap","2":"8px"}]})])],64)}}};export{X as default,U as meta};
