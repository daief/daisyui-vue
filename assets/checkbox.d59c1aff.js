import{w as i,c as s,a2 as e,i as m,a as p,u as v,a4 as b,a5 as t,a6 as a,q as _,a7 as k}from"./vendor.5032f317.js";var y={setup:()=>{const l=i(!1),n=d=>{l.value=d.target.checked,console.log("Checked:",l.value)};return()=>s(e("dv-checkbox"),{checked:l.value,onChange:n},null)}};function f(l){return typeof l=="function"||Object.prototype.toString.call(l)==="[object Object]"&&!m(l)}var w={setup:()=>{const l=["neutral","primary","secondary","accent"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[l.map(n=>s("div",{key:n,class:"w-32"},[s(e("dv-checkbox"),{variant:n,defaultChecked:!0},f(n)?n:{default:()=>[n]})]))])}},C={setup:()=>{const l=["xs","sm","md","lg"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[l.map(n=>s("div",{key:n},[s(e("dv-checkbox"),{size:n,defaultChecked:!0},null)]))])}},z={setup:()=>{const l=[{value:"apple",label:"Apple"},{value:"pear",label:"Pear"},{value:"orange",label:"Orange"}],n=i(["apple","pear"]),d=i(!1);return()=>s("div",null,[s("div",{class:"flex items-center"},[s("label",{class:"mr-4"},[p("Disabled:")]),s(e("dv-toggle"),{checked:d.value,onChange:h=>d.value=h.target.checked},null)]),s(e("dv-divider"),null,null),s(e("dv-checkbox-group"),{size:"lg",options:l,disabled:d.value,modelValue:n.value,"onUpdate:modelValue":h=>n.value=h},null)])}};const I=a("div",{class:"markdown-body"},[a("h1",null,"Checkbox"),a("h2",null,"Examples"),a("p",null,"Checkbox")],-1),q=a("div",{class:"markdown-body"},[a("p",null,"With label")],-1),O=p("Orange"),S=p(),A=p("Apple"),V=a("div",{class:"markdown-body"},[a("p",null,"Color type")],-1),P=a("div",{class:"markdown-body"},[a("p",null,"Sizes")],-1),T=a("div",{class:"markdown-body"},[a("p",null,"Disabled")],-1),N=p("Orange"),B=p("Apple"),D=a("div",{class:"markdown-body"},[a("p",null,"Indeterminate(style only, do not affect the value)")],-1),E=p("Orange"),F=p("Apple"),G=p("Pear"),M=a("div",{class:"markdown-body"},[a("p",null,"Group")],-1),H={class:"markdown-body"},U=a("h2",null,"Checkbox",-1),W=a("h3",null,"Attributes",-1),J=a("h2",null,"CheckboxGroup",-1),K=a("h3",null,"Attributes",-1),L=a("h2",null,"CSS variables",-1),Y=[],Z={setup(l,{expose:n}){return n({frontmatter:{meta:[]}}),v({meta:[]}),(Q,R)=>{const u=y,c=e("Playground"),o=e("dv-checkbox"),j=w,g=C,x=z,r=e("MarkdownTable");return k(),b(_,null,[I,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:t(()=>[s(u)]),_:1}),q,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span> <span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span>&gt;</span>Apple<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
`},{default:t(()=>[s(o,null,{default:t(()=>[O]),_:1}),S,s(o,null,{default:t(()=>[A]),_:1})]),_:1}),V,s(c,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
...
`},{default:t(()=>[s(j)]),_:1}),P,s(c,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
...
`},{default:t(()=>[s(g)]),_:1}),T,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span> <span class="hljs-attr">disabled</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
...
`},{default:t(()=>[s(o,{disabled:""},{default:t(()=>[N]),_:1}),s(o,{defaultChecked:"",disabled:""},{default:t(()=>[B]),_:1})]),_:1}),D,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span> <span class="hljs-attr">indeterminate</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
...
`},{default:t(()=>[s(o,{indeterminate:""},{default:t(()=>[E]),_:1}),s(o,{indeterminate:"",defaultChecked:""},{default:t(()=>[F]),_:1}),s(o,{indeterminate:"",disabled:""},{default:t(()=>[G]),_:1})]),_:1}),M,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:t(()=>[s(x)]),_:1}),a("div",H,[U,W,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"size","1":"size","2":"ISize","3":"md"},{"0":"variant","1":"color type","2":"neutral, primary, secondary, accent","3":"neutral"},{"0":"disabled","1":"disable status","2":"bool","3":"-"},{"0":"checked","1":"checked status","2":"bool","3":"-"},{"0":"onChange","1":"change callback","2":"Function","3":"-"},{"0":"defaultChecked","1":"initial checked status","2":"bool","3":"-"},{"0":"readOnly","1":"read only status","2":"bool","3":"-"},{"0":"options","1":"checkbox options","2":"IOption[]","3":"-"},{"0":"indeterminate","1":"indeterminate status. style only, do not affect the value","2":"bool","3":"-"}]},null,8,["dataSource"]),J,K,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"v-model","1":"v-model for selected values","2":"IText[]","3":"-"},{"0":"size","1":"size","2":"ISize","3":"md"},{"0":"variant","1":"color type","2":"neutral, primary, secondary, accent","3":"neutral"},{"0":"disabled","1":"disable status","2":"bool","3":"-"},{"0":"options","1":"options","2":"IOption[]","3":"-"},{"0":"defaultValue","1":"initial values","2":"IText[]","3":"-"}]}),L,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"default",dataIndex:2}],dataSource:[{"0":"--dv-checkbox-gap","1":"checkbox horizontal gap","2":"8px"}]})])],64)}}};export{Z as default,Y as meta};
