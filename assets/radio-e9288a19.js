import{g as d,a as s,d as h,r as t,F as u,_ as v,u as y,o as _,c as f,w as c,b as a}from"./app-f7b9d8d9.js";const w={setup:()=>{const l=[{value:"apple",label:"Apple"},{value:"pear",label:"Pear"},{value:"orange",label:"Orange"}],n=d("apple"),p=d(!1);return()=>s("div",null,[s("div",{class:"flex items-center"},[s("label",{class:"mr-4"},[h("Disabled:")]),s(t("dv-toggle"),{checked:p.value,onChange:o=>p.value=o.target.checked},null)]),s(t("dv-divider"),null,null),s(t("dv-radio-group"),{size:"lg",options:l,disabled:p.value,modelValue:n.value,"onUpdate:modelValue":o=>n.value=o},null)])}},b={setup:()=>{const l=["xs","sm","md","lg"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[l.map(n=>s("div",{key:n},[s(t("dv-radio"),{size:n},null)]))])}},k={setup:()=>{const l=["neutral","primary","secondary","accent"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[l.map(n=>s("div",{key:n,class:"w-32"},[s(t("dv-radio"),{variant:n},{default:()=>[n]})]))])}},q={setup:()=>{const l=d("a"),n=p=>{l.value=p.target.value};return()=>s(u,null,[s(t("dv-radio"),{checked:l.value==="a",onChange:n,name:"radio-2",value:"a"},null),s(t("dv-radio"),{checked:l.value==="b",onChange:n,name:"radio-2",value:"b"},null)])}},C=a("div",{class:"markdown-body"},[a("h1",null,"Radio"),a("h2",null,"Examples"),a("p",null,"Radio")],-1),z=h(),I=a("div",{class:"markdown-body"},[a("p",null,"value & change")],-1),S=a("div",{class:"markdown-body"},[a("p",null,"Color type")],-1),T=a("div",{class:"markdown-body"},[a("p",null,"Sizes")],-1),V=a("div",{class:"markdown-body"},[a("p",null,"Group")],-1),A={class:"markdown-body"},O=a("h2",null,"Radio",-1),P=a("h3",null,"Attributes",-1),R=a("h2",null,"RadioGroup",-1),B=a("h3",null,"Attributes",-1),N=a("h2",null,"CSS variables",-1),M=[],D={setup(l,{expose:n}){return n({frontmatter:{meta:[]}}),y({meta:[]}),(E,F)=>{const i=t("dv-radio"),e=t("Playground"),j=q,g=k,x=b,m=w,r=t("MarkdownTable");return _(),f(u,null,[C,s(e,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-radio</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;radio-1&quot;</span> /&gt;</span> <span class="hljs-tag">&lt;<span class="hljs-name">dv-radio</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;radio-1&quot;</span> /&gt;</span>
`},{default:c(()=>[s(i,{name:"radio-1"}),z,s(i,{name:"radio-1"})]),_:1}),I,s(e,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:c(()=>[s(j)]),_:1}),S,s(e,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
...
`},{default:c(()=>[s(x)]),_:1}),V,s(e,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:c(()=>[s(m)]),_:1}),a("div",A,[O,P,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{0:"size",1:"size",2:"ISize",3:"md"},{0:"variant",1:"color type",2:"neutral, primary, secondary, accent",3:"neutral"},{0:"disabled",1:"disable status",2:"bool",3:"-"},{0:"checked",1:"checked status",2:"bool",3:"-"},{0:"value",1:"input value",2:"IText",3:"-"},{0:"name",1:"input name",2:"string",3:"-"},{0:"readOnly",1:"read only status",2:"bool",3:"-"}]}),R,B,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{0:"size",1:"size",2:"ISize",3:"md"},{0:"variant",1:"color type",2:"neutral, primary, secondary, accent",3:"neutral"},{0:"disabled",1:"disable status",2:"bool",3:"-"},{0:"options",1:"options",2:"IOption[]",3:"-"},{0:"v-model",1:"v-model for selected value",2:"IText",3:"-"},{0:"defaultValue",1:"initial value",2:"IText",3:"-"}]}),N,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"default",dataIndex:2}],dataSource:[{0:"--dv-radio-gap",1:"checkbox horizontal gap",2:"8px"}]})])],64)}}},H=v(D,[["__file","/home/runner/work/daisyui-vue/daisyui-vue/docs/src/pages/components/radio.md"]]);export{H as default,M as meta};
