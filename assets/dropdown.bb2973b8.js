...
`},{default:a(()=>[n("div",T,[s(u,{triggerAction:"click"},{content:a(()=>[s(i,{class:"shadow-lg rounded-lg bg-white p-2 w-56"},{default:a(()=>[s(d,null,{default:a(()=>[A]),_:1}),s(d,null,{default:a(()=>[H]),_:1})]),_:1})]),default:a(()=>[s(g,null,{default:a(()=>[z]),_:1})]),_:1})])]),_:1}),B,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text-center&quot;</span>&gt;</span>
