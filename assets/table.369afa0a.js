...
</code></pre>`,2),D=[],G={setup(n,{expose:l}){return l({frontmatter:{meta:[]}}),f({meta:[]}),(i,u)=>{const r=C,e=p("Playground"),x=S,d=k,m=p("MarkdownTable");return o(),y(j,null,[z,s(e,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
...
`},{default:c(()=>[s(d)]),_:1}),a("div",A,[H,q,s(m,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"columns","1":"table columns config","2":"ITableColumn[]","3":"-"},{"0":"dataSource","1":"table data source","2":"array","3":"-"},{"0":"compact","1":"makes table more compact","2":"boolean","3":"-"},{"0":"zebra","1":"makes table rows zebra","2":"boolean","3":"-"}]}),P])],64)}}};export{G as default,D as meta};
