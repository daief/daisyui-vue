...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[s("div",T,[a(l,{size:"xs",class:"w-full max-w-xs",placeholder:"xs size"}),I,a(l,{size:"sm",class:"w-full max-w-xs",placeholder:"sm size"}),B,a(l,{size:"md",class:"w-full max-w-xs",placeholder:"md size"}),C,a(l,{size:"lg",class:"w-full max-w-xs",placeholder:"lg size"})])]),_:1}),A,a(n,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text-center&quot;</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[s("div",E,[a(l,{class:"w-full max-w-xs",placeholder:"disabled",disabled:""})])]),_:1}),s("div",F,[M,N,a(e,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"type","1":"input color type","2":"netural, primary, secondary, accent, info, success, warning, error, ghost","3":"netural"},{"0":"size","1":"input size","2":"ISize","3":"md"},{"0":"border","1":"input border","2":"boolean","3":"true"}]})])],64)}}};export{J as default};
