...
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-space</span>&gt;</span>
`},{default:n(()=>[s(d,{direction:"vertical"},{default:n(()=>[L,s(u,null,{default:n(()=>[O]),_:1}),s(u,null,{default:n(()=>[U]),_:1})]),_:1})]),_:1}),W,s(o,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:n(()=>[s(x)]),_:1}),G,s(o,{lang:"html",code:`<span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>
...
`},{default:n(()=>[s(f)]),_:1}),J,s(o,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:n(()=>[s(y)]),_:1}),K,s(o,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-space</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;w-64 max-w-full&quot;</span> <span class="hljs-attr">block</span> <span class="hljs-attr">wrap</span> <span class="hljs-attr">:spacing</span>=<span class="hljs-string">&quot;[12, 4]&quot;</span>&gt;</span>
