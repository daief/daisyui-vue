import{c as s,a as c,b as l,u as o,d as g,w as h,e as a,F as i,o as m}from"./app.3a1dcfbf.js";var d={setup:()=>{const t=["squircle","heart","hexagon","hexagon-2","decagon","pentagon","diamond","square","circle","parallelogram","parallelogram-2","parallelogram-3","parallelogram-4","star","star-2","triangle","triangle-2","triangle-3","triangle-4"];return()=>s("div",null,[t.map(n=>s("div",{key:n},[s("p",{class:"my-2"},[c("mask-"),n]),s(l("dv-mask"),{type:n,class:"mb-8"},{default:()=>[s("img",{src:"https://placeimg.com/192/192/people"},null)]})]))])}};const x=a("div",{class:"markdown-body"},[a("h1",null,"Mask"),a("h2",null,"Examples"),a("p",null,"mask")],-1),j={class:"markdown-body"},u=a("h2",null,"Mask",-1),y=a("h3",null,"Attributes",-1),q=[],b={setup(t,{expose:n}){return n({frontmatter:{meta:[]}}),o({meta:[]}),(v,f)=>{const p=d,e=l("Playground"),r=l("MarkdownTable");return m(),g(i,null,[x,s(e,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
...
`},{default:h(()=>[s(p)]),_:1}),a("div",j,[u,y,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{0:"type",1:"the shape type of content",2:"squircle, heart, hexagon, hexagon-2, decagon, pentagon, diamond, square, circle, parallelogram, parallelogram-2, parallelogram-3, parallelogram-4, star, star-2, triangle, triangle-2, triangle-3, triangle-4",3:"squircle"}]})])],64)}}};export{b as default,q as meta};
