...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[a("div",C,[s(c,{animation:"rotate"},{on:t(()=>[s(i,{size:"48px"})]),off:t(()=>[s(d,{size:"48px"})]),_:1})])]),_:1}),S,s(l,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
    <span class="hljs-keyword">return</span> <span class="hljs-function">() =&gt;</span> (
...
`},{default:t(()=>[s(u)]),_:1}),a("div",I,[N,A,s(o,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"on","1":"render on","2":"-","3":"-"},{"0":"off","1":"render off","2":"-","3":"-"},{"0":"tag","1":"wrap elemnt tag","2":"string","3":"label"},{"0":"animation","1":"animation effect","2":"rotate, flip","3":"-"}]}),B,s(o,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1}],dataSource:[{"0":"on","1":"render on"},{"0":"off","1":"render off"}]})])],64)}}};export{H as default,P as meta};
