...
</code></pre>`,2),M=[],D={setup(n,{expose:l}){return l({frontmatter:{meta:[]}}),y({meta:[]}),(u,x)=>{const c=_,r=p("Playground"),d=S,m=k,g=p("MarkdownTable");return o(),j(h,null,[z,s(r,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
...
`},{default:e(()=>[s(m)]),_:1}),a("div",B,[A,H,s(g,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{0:"columns",1:"table columns config",2:"ITableColumn[]",3:"-"},{0:"dataSource",1:"table data source",2:"array",3:"-"},{0:"compact",1:"makes table more compact",2:"boolean",3:"-"},{0:"zebra",1:"makes table rows zebra",2:"boolean",3:"-"}]}),P])],64)}}};export{D as default,M as meta};
