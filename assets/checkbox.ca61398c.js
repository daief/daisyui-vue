import{O as i,c as s,a7 as e,a as p,u as m,a9 as v,aa as n,ab as a,F as k,ac as _}from"./vendor.b4c19bdc.js";var b={setup:()=>{const t=i(!1),l=d=>{t.value=d.target.checked,console.log("Checked:",t.value)};return()=>s(e("dv-checkbox"),{checked:t.value,onChange:l},null)}},y={setup:()=>{const t=["neutral","primary","secondary","accent"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[t.map(l=>s("div",{key:l,class:"w-32"},[s(e("dv-checkbox"),{variant:l,defaultChecked:!0},{default:()=>[l]})]))])}},f={setup:()=>{const t=["xs","sm","md","lg"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[t.map(l=>s("div",{key:l},[s(e("dv-checkbox"),{size:l,defaultChecked:!0},null)]))])}},w={setup:()=>{const t=[{value:"apple",label:"Apple"},{value:"pear",label:"Pear"},{value:"orange",label:"Orange"}],l=i(["apple","pear"]),d=i(!1);return()=>s("div",null,[s("div",{class:"flex items-center"},[s("label",{class:"mr-4"},[p("Disabled:")]),s(e("dv-toggle"),{checked:d.value,onChange:h=>d.value=h.target.checked},null)]),s(e("dv-divider"),null,null),s(e("dv-checkbox-group"),{size:"lg",options:t,disabled:d.value,modelValue:l.value,"onUpdate:modelValue":h=>l.value=h},null)])}};const C=a("div",{class:"markdown-body"},[a("h1",null,"Checkbox"),a("h2",null,"Examples"),a("p",null,"Checkbox")],-1),z=a("div",{class:"markdown-body"},[a("p",null,"With label")],-1),I=p("Orange"),q=p(),O=p("Apple"),A=a("div",{class:"markdown-body"},[a("p",null,"Color type")],-1),S=a("div",{class:"markdown-body"},[a("p",null,"Sizes")],-1),P=a("div",{class:"markdown-body"},[a("p",null,"Disabled")],-1),V=p("Orange"),T=p("Apple"),B=a("div",{class:"markdown-body"},[a("p",null,"Indeterminate(style only, do not affect the value)")],-1),D=p("Orange"),F=p("Apple"),N=p("Pear"),E=a("div",{class:"markdown-body"},[a("p",null,"Group")],-1),G={class:"markdown-body"},M=a("h2",null,"Checkbox",-1),H=a("h3",null,"Attributes",-1),U=a("h2",null,"CheckboxGroup",-1),W=a("h3",null,"Attributes",-1),J=a("h2",null,"CSS variables",-1),R=[],X={setup(t,{expose:l}){return l({frontmatter:{meta:[]}}),m({meta:[]}),(K,L)=>{const u=b,c=e("Playground"),o=e("dv-checkbox"),j=y,g=f,x=w,r=e("MarkdownTable");return _(),v(k,null,[C,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:n(()=>[s(u)]),_:1}),z,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span> <span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span>&gt;</span>Apple<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
`},{default:n(()=>[s(o,null,{default:n(()=>[I]),_:1}),q,s(o,null,{default:n(()=>[O]),_:1})]),_:1}),A,s(c,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
...
`},{default:n(()=>[s(j)]),_:1}),S,s(c,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
...
`},{default:n(()=>[s(g)]),_:1}),P,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span> <span class="hljs-attr">disabled</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
...
`},{default:n(()=>[s(o,{disabled:""},{default:n(()=>[V]),_:1}),s(o,{defaultChecked:"",disabled:""},{default:n(()=>[T]),_:1})]),_:1}),B,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-checkbox</span> <span class="hljs-attr">indeterminate</span>&gt;</span>Orange<span class="hljs-tag">&lt;/<span class="hljs-name">dv-checkbox</span>&gt;</span>
...
`},{default:n(()=>[s(o,{indeterminate:""},{default:n(()=>[D]),_:1}),s(o,{indeterminate:"",defaultChecked:""},{default:n(()=>[F]),_:1}),s(o,{indeterminate:"",disabled:""},{default:n(()=>[N]),_:1})]),_:1}),E,s(c,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:n(()=>[s(x)]),_:1}),a("div",G,[M,H,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"size","1":"size","2":"ISize","3":"md"},{"0":"variant","1":"color type","2":"neutral, primary, secondary, accent","3":"neutral"},{"0":"disabled","1":"disable status","2":"bool","3":"-"},{"0":"checked","1":"checked status","2":"bool","3":"-"},{"0":"onChange","1":"change callback","2":"Function","3":"-"},{"0":"defaultChecked","1":"initial checked status","2":"bool","3":"-"},{"0":"readOnly","1":"read only status","2":"bool","3":"-"},{"0":"options","1":"checkbox options","2":"IOption[]","3":"-"},{"0":"indeterminate","1":"indeterminate status. style only, do not affect the value","2":"bool","3":"-"}]},null,8,["dataSource"]),U,W,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"v-model","1":"v-model for selected values","2":"IText[]","3":"-"},{"0":"size","1":"size","2":"ISize","3":"md"},{"0":"variant","1":"color type","2":"neutral, primary, secondary, accent","3":"neutral"},{"0":"disabled","1":"disable status","2":"bool","3":"-"},{"0":"options","1":"options","2":"IOption[]","3":"-"},{"0":"defaultValue","1":"initial values","2":"IText[]","3":"-"}]}),J,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"default",dataIndex:2}],dataSource:[{"0":"--dv-checkbox-gap","1":"checkbox horizontal gap","2":"8px"}]})])],64)}}};export{X as default,R as meta};
