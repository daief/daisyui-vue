import{u as b,p as f,Y as p,_ as q,$ as w,c as s,a0 as a,a1 as n,n as y,a3 as x,a as l}from"./vendor.1d9a2266.js";const k=x(`<div class="markdown-body"><h1>Drawer</h1><h2>Examples</h2><pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">setup</span> <span class="hljs-attr">lang</span>=<span class="hljs-string">&quot;ts&quot;</span>&gt;</span><span class="language-javascript">
...
</code></pre><p>global drawer, mouts on body. content has a animation.</p></div>`,1),C={class:"bg-white w-80 py-4"},z=l("item1"),O=l("item2"),I=l("item3"),T={class:"rounded-lg shadow bg-base-200 h-52 flex justify-center items-center"},M=l("open"),S=n("div",{class:"markdown-body"},[n("p",null,"drawer disable teleport")],-1),N={class:"bg-white w-80 py-4"},R=l("item1"),V=l("item2"),B=l("item3"),E={class:"h-full flex justify-center items-center"},D=l(" open "),P=n("div",{class:"markdown-body"},[n("p",null,"sliding drawer for mobile only")],-1),A={class:"bg-white w-80 py-4 border-r border-gray-100"},F=l("item1"),H=l("item2"),Y=l("item3"),$={class:"h-full flex justify-center items-center text-center"},G=n("p",{class:"hidden lg:block px-5"}," Menu is always open on desktop size. Resize the browser to see toggle button on mobile size ",-1),J={class:"lg:hidden px-5"},K=n("p",null,[l("Menu can be toggled on mobile size. "),n("br"),l(" Resize the browser to see fixed sidebar on desktop size ")],-1),L=l(" open "),Q=n("div",{class:"markdown-body"},[n("p",null,"navbar menu for desktop + drawer for mobile")],-1),U={class:"bg-white w-80 py-4 border-r border-gray-100"},W=l("item1"),X=l("item2"),Z=l("item3"),ss={class:"flex-none lg:hidden"},as=n("div",{class:"flex-1 mx-2"}," Change screen size to show/hide menu ",-1),ns={class:"flex-none hidden lg:block"},ls=l("item1"),ts=l("item2"),ps=l("item3"),es=n("div",{class:"markdown-body"},[n("p",null,"drawer right")],-1),cs={class:"rounded-lg shadow bg-base-200 h-52 flex justify-center items-center"},os=l("open"),hs={class:"bg-white w-80 py-4"},ds=l("item1"),is=l("item2"),js=l("item3"),gs={class:"markdown-body"},ms=n("h2",null,"Drawer",-1),rs=n("h3",null,"Attributes",-1),us=n("h3",null,"Events",-1),_s=n("h3",null,"Slots",-1),ys=[],xs={setup(vs,{expose:u}){u({frontmatter:{meta:[]}}),b({meta:[]});const m=f(null);function c(g){m.value=g}function o(){m.value=null}function h(g){return m.value===g}return(g,qs)=>{const t=p("dv-menu-item"),e=p("dv-menu"),d=p("dv-button"),i=p("dv-drawer"),j=p("Playground"),_=p("icon-menu"),v=p("dv-navbar"),r=p("MarkdownTable");return q(),w(y,null,[k,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-drawer</span> <span class="hljs-attr">:open</span>=<span class="hljs-string">&quot;isOpen(&#x27;d1&#x27;)&quot;</span> @<span class="hljs-attr">close</span>=<span class="hljs-string">&quot;close&quot;</span>&gt;</span>
...
`},{default:a(()=>[s(i,{open:h("d1"),onClose:o},{content:a(()=>[n("div",T,[s(d,{onClick:()=>c("d1"),type:"primary"},{default:a(()=>[M]),_:1},8,["onClick"])])]),default:a(()=>[n("div",C,[s(e,null,{default:a(()=>[s(t,null,{default:a(()=>[z]),_:1}),s(t,null,{default:a(()=>[O]),_:1}),s(t,null,{default:a(()=>[I]),_:1})]),_:1})])]),_:1},8,["open"])]),_:1}),S,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
...
&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-drawer</span>&gt;</span>
`},{default:a(()=>[s(i,{open:h("d3"),disableTeleport:"",mobileOnly:"",onClose:o,class:"rounded-lg shadow bg-base-200 h-52"},{default:a(()=>[n("div",A,[s(e,{class:"px-4"},{default:a(()=>[s(t,null,{default:a(()=>[F]),_:1}),s(t,null,{default:a(()=>[H]),_:1}),s(t,null,{default:a(()=>[Y]),_:1})]),_:1})])]),content:a(()=>[n("div",$,[G,n("div",J,[K,s(d,{onClick:()=>c("d3"),type:"primary"},{default:a(()=>[L]),_:1},8,["onClick"])])])]),_:1},8,["open"])]),_:1}),Q,s(j,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-drawer</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">dv-drawer</span> <span class="hljs-attr">:open</span>=<span class="hljs-string">&quot;isOpen(&#x27;d5&#x27;)&quot;</span> @<span class="hljs-attr">close</span>=<span class="hljs-string">&quot;close&quot;</span> <span class="hljs-attr">placement</span>=<span class="hljs-string">&quot;right&quot;</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-drawer</span>&gt;</span>
`},{default:a(()=>[n("div",cs,[s(d,{onClick:()=>c("d5"),type:"primary"},{default:a(()=>[os]),_:1},8,["onClick"])]),s(i,{open:h("d5"),onClose:o,placement:"right"},{default:a(()=>[n("div",hs,[s(e,null,{default:a(()=>[s(t,null,{default:a(()=>[ds]),_:1}),s(t,null,{default:a(()=>[is]),_:1}),s(t,null,{default:a(()=>[js]),_:1})]),_:1})])]),_:1},8,["open"])]),_:1}),n("div",gs,[ms,rs,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"open","1":"drawer open/close status","2":"boolean","3":"-"},{"0":"disableTeleport","1":"disable teleport behavior","2":"boolean","3":"-"},{"0":"mobileOnly","1":"makes drawer to open/close on mobile but will be always visible on desktop","2":"boolean","3":"-"},{"0":"placement","1":"drawer open position","2":"left, right","3":"left"},{"0":"placement","1":"drawer open position","2":"left, right","3":"left"}]}),us,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"close","1":"drawer close event","2":"function","3":"-"}]}),_s,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1}],dataSource:[{"0":"default","1":"drawer side content"},{"0":"content","1":"drawer content"}]})])],64)}}};export{xs as default,ys as meta};
