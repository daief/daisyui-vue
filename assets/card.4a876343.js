...
`},{default:t(()=>[a("div",C,[s(p,{bordered:"",image:"https://picsum.photos/id/1005/400/250",title:"Image overlay",description:`Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.`,"image-full":""},{actions:t(()=>[s(e,{type:"secondary"},{default:t(()=>[T]),_:1})]),_:1})])]),_:1}),N,s(i,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-card</span>
    <span class="hljs-attr">bordered</span>
    <span class="hljs-attr">image</span>=<span class="hljs-string">&quot;https://picsum.photos/id/1005/400/250&quot;</span>
 ...
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.&quot;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-card</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[a("div",B,[s(p,{bordered:"",image:"https://picsum.photos/id/1005/400/250",title:"This card is compact",description:`Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit
...
`},{default:t(()=>[a("div",null,[s(p,{bordered:"",image:"https://picsum.photos/id/1005/400/250",title:"Horizontal",description:`Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.`,side:""},{actions:t(()=>[s(e,{type:"secondary"},{default:t(()=>[H]),_:1})]),_:1})])]),_:1}),V,s(i,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-card</span>
    <span class="hljs-attr">bordered</span>
...
`},{default:t(()=>[a("div",null,[s(p,{bordered:"",title:"No Images",description:`Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.`},{actions:t(()=>[s(e,{type:"secondary"},{default:t(()=>[z]),_:1})]),_:1})])]),_:1}),E,s(i,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>
...
&gt;</span>
 ...
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.&quot;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-card</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[a("div",F,[s(p,{bordered:"",glass:"",side:"",image:"https://picsum.photos/id/1005/300/200",title:"Glass",description:`Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.`},{default:t(()=>[s(u,{class:"p-6"},{default:t(()=>[L]),_:1}),s(r,null,{default:t(()=>[s(o,null,{default:t(()=>[Y]),_:1}),$,s(d,null,{default:t(()=>[s(e,{type:"glass"},{default:t(()=>[D]),_:1})]),_:1})]),_:1})]),_:1})])]),_:1}),a("div",J,[K,O,s(c,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"bordered","1":"adds border to card","2":"boolean","3":"true"},{"0":"side","1":"the image in figure will be on to the side","2":"boolean","3":"false"},{"0":"imageFull","1":"the image in figure element will be the background","2":"boolean","3":"false"},{"0":"compact","1":"applies smaller padding","2":"boolean","3":"false"},{"0":"glass","1":"applies glass style","2":"boolean","3":"false"},{"0":"image","1":"image url of card (works when no default solt)","2":"string","3":"-"},{"0":"title","1":"title of card (works when no default solt)","2":"string","3":"-"},{"0":"description","1":"description of card (works when no default solt)","2":"string","3":"-"}]},null,8,["dataSource"]),Q,s(c,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1}],dataSource:[{"0":"default","1":"card content"},{"0":"actions","1":"card actions(this works only when slots.default is undefined)"}]},null,8,["dataSource"]),U,W,s(c,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"src","1":"image url of card","2":"string","3":"-"}]}),X,Z,ss,as,ts,s(c,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"component","1":"the rendered element of title","2":"string","3":"h2"}]}),ns,ls,es])],64)}}};export{hs as default,us as meta};
