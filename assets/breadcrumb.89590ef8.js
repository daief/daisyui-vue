import{u as o,z as e,A as u,c as s,B as a,F as h,C as n,D as b,a as t}from"./vendor.88f27aa7.js";const g=n("div",{class:"markdown-body"},[n("h1",null,"Breadcrumb"),n("h2",null,"Examples"),n("p",null,"breadcrumbs")],-1),_=t("Home"),j=t("Documents"),i=t("Add Document"),v=n("div",{class:"markdown-body"},[n("p",null,"breadcrumbs with icon")],-1),f=t(" Home "),w=t(" Documents "),x=t(" Add Document "),D=n("div",{class:"markdown-body"},[n("p",null,"breadcrumbs overflow scroll")],-1),q=t("If you set max-width"),y=t("or the list"),B=t("gets larger than"),k=t("the container"),A=t("it will scroll"),H=n("div",{class:"markdown-body"},[n("h2",null,"Breadcrumb"),n("p",null,[n("code",null,"-")]),n("h2",null,"BreadcrumbItem"),n("p",null,[n("code",null,"-")])],-1),P=[],z={setup(C,{expose:m}){return m({frontmatter:{meta:[]}}),o({meta:[]}),(V,E)=>{const l=e("dv-breadcrumb-item"),c=e("dv-breadcrumb"),d=e("Playground"),p=e("dv-icon-folder"),r=e("dv-icon-document-add");return b(),u(h,null,[g,s(d,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-breadcrumb</span>&gt;</span>
...
`},{default:a(()=>[s(c,null,{default:a(()=>[s(l,null,{default:a(()=>[_]),_:1}),s(l,null,{default:a(()=>[j]),_:1}),s(l,null,{default:a(()=>[i]),_:1})]),_:1})]),_:1}),v,s(d,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-breadcrumb</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-breadcrumb-item</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-breadcrumb</span>&gt;</span>
`},{default:a(()=>[s(c,null,{default:a(()=>[s(l,null,{default:a(()=>[s(p,{class:"mr-1"}),f]),_:1}),s(l,null,{default:a(()=>[s(p,{class:"mr-1"}),w]),_:1}),s(l,null,{default:a(()=>[s(r,{class:"mr-1"}),x]),_:1})]),_:1})]),_:1}),D,s(d,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-breadcrumb</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;max-w-sm&quot;</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-breadcrumb</span>&gt;</span>
`},{default:a(()=>[s(c,{class:"max-w-sm"},{default:a(()=>[s(l,null,{default:a(()=>[q]),_:1}),s(l,null,{default:a(()=>[y]),_:1}),s(l,null,{default:a(()=>[B]),_:1}),s(l,null,{default:a(()=>[k]),_:1}),s(l,null,{default:a(()=>[A]),_:1})]),_:1})]),_:1}),H],64)}}};export{z as default,P as meta};
