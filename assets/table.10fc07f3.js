import{c as s,j as p,o,k as m,a as g,F as b,u as f,l as y,q as e,s as l,t as _}from"./vendor.70ccab45.js";import{_ as v}from"./app.15dd7c00.js";var C={setup:()=>{const a=[{title:"",dataIndex:"num",fixed:"left",width:20},{title:"name",dataIndex:"name"},{title:"job",dataIndex:"job"},{title:"favorite color",dataIndex:"favoriteColor"}],n=[{num:1,name:"Cy Ganderton",job:"Quality Control Specialist",favoriteColor:"Blue"},{num:2,name:"Hart Hagerty",job:"Desktop Support Technician",favoriteColor:"Purple"},{num:3,name:"Brice Swyre",job:"Tax Accountant",favoriteColor:"Red"},{num:4,name:"Marjy Ferencz",job:"Office Assistant I",favoriteColor:"Crimson"}];return()=>s(p("dv-table"),{columns:a,dataSource:n},null)}},w={setup:()=>({columns:[{title:"",dataIndex:"num",fixed:"left",width:20},{title:"name",dataIndex:"name"},{title:"job",dataIndex:"job"},{title:"favorite color",dataIndex:"favoriteColor"}],dataSource:[{num:1,name:"Cy Ganderton",job:"Quality Control Specialist",favoriteColor:"Blue"},{num:2,name:"Hart Hagerty",job:"Desktop Support Technician",favoriteColor:"Purple"},{num:3,name:"Brice Swyre",job:"Tax Accountant",favoriteColor:"Red"},{num:4,name:"Marjy Ferencz",job:"Office Assistant I",favoriteColor:"Crimson"}]})};function S(a,n,t,j,h,i){const r=p("dv-table");return o(),m(r,{columns:a.columns,dataSource:a.dataSource,zebra:"",compact:""},null,8,["columns","dataSource"])}var I=v(w,[["render",S]]),k={setup:()=>{const a=[{title:"",dataIndex:"num",fixed:"left",width:20,render:t=>s("strong",null,[t])},{title:"name",dataIndex:"name"},{title:"job",dataIndex:"job"},{title:()=>s(b,null,[s(p("dv-icon-color"),{size:"1.5em",style:"margin-right: 6px"},null),g("favorite color")]),dataIndex:"favoriteColor",render:t=>s("span",{style:{color:t}},[t])}],n=[{num:1,name:"Cy Ganderton",job:"Quality Control Specialist",favoriteColor:"Blue"},{num:2,name:"Hart Hagerty",job:"Desktop Support Technician",favoriteColor:"Purple"},{num:3,name:"Brice Swyre",job:"Tax Accountant",favoriteColor:"Red"},{num:4,name:"Marjy Ferencz",job:"Office Assistant I",favoriteColor:"Crimson"}];return()=>s(p("dv-table"),{columns:a,dataSource:n},null)}};const z={class:"markdown-body"},T=l("h1",null,"Table",-1),A=l("h2",null,"Examples",-1),B=l("p",null,"table",-1),H=l("p",null,"table-zebra & table-compact",-1),q=l("p",null,"table-jsx",-1),F=l("h2",null,"Table",-1),M=l("h3",null,"Attributes",-1),P=_(`<h3>ITableColumn</h3><pre><code class="hljs language-ts"><span class="hljs-keyword">interface</span> ITableColumn&lt;T = unknown&gt; {
...
</code></pre>`,2),O={setup(a,{expose:n}){return n({frontmatter:{meta:[]}}),f({meta:[]}),(h,i)=>{const r=C,c=p("Playground"),u=I,x=k,d=p("MarkdownTable");return o(),y("div",z,[T,A,B,s(c,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
...
`},{default:e(()=>[s(r)]),_:1}),H,s(c,{lang:"html",code:`<span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>
...
`},{default:e(()=>[s(u)]),_:1}),q,s(c,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
    <span class="hljs-keyword">const</span> columns = [
      {
        <span class="hljs-attr">title</span>: <span class="hljs-string">&#x27;&#x27;</span>,
...
`},{default:e(()=>[s(x)]),_:1}),F,M,s(d,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"columns","1":"table columns config","2":"ITableColumn[]","3":"-"},{"0":"dataSource","1":"table data source","2":"array","3":"-"},{"0":"compact","1":"makes table more compact","2":"boolean","3":"-"},{"0":"zebra","1":"makes table rows zebra","2":"boolean","3":"-"}]}),P])}}};export{O as default};
