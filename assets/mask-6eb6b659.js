import{a as s,d as c,r as l,_ as o,u as g,o as h,c as i,w as m,b as a,F as d}from"./app-33be3538.js";const x={setup:()=>{const t=["squircle","heart","hexagon","hexagon-2","decagon","pentagon","diamond","square","circle","parallelogram","parallelogram-2","parallelogram-3","parallelogram-4","star","star-2","triangle","triangle-2","triangle-3","triangle-4"];return()=>s("div",null,[t.map(n=>s("div",{key:n},[s("p",{class:"my-2"},[c("mask-"),n]),s(l("dv-mask"),{type:n,class:"mb-8"},{default:()=>[s("img",{src:"https://placeimg.com/192/192/people"},null)]})]))])}},j=a("div",{class:"markdown-body"},[a("h1",null,"Mask"),a("h2",null,"Examples"),a("p",null,"mask")],-1),u={class:"markdown-body"},y=a("h2",null,"Mask",-1),_=a("h3",null,"Attributes",-1),C=[],k={setup(t,{expose:n}){return n({frontmatter:{meta:[]}}),g({meta:[]}),(w,q)=>{const p=x,e=l("Playground"),r=l("MarkdownTable");return h(),i(d,null,[j,s(e,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
        ...
        {types.map((type) =&gt; (
          <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">key</span>=<span class="hljs-string">{type}</span>&gt;</span>
            ...
            <span class="hljs-tag">&lt;<span class="hljs-name">dv-mask</span> <span class="hljs-attr">type</span>=<span class="hljs-string">{type}</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;mb-8&quot;</span>&gt;</span>
              <span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;https://placeimg.com/192/192/people&quot;</span> /&gt;</span>
...
`},{default:m(()=>[s(p)]),_:1}),a("div",u,[y,_,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{0:"type",1:"the shape type of content",2:"squircle, heart, hexagon, hexagon-2, decagon, pentagon, diamond, square, circle, parallelogram, parallelogram-2, parallelogram-3, parallelogram-4, star, star-2, triangle, triangle-2, triangle-3, triangle-4",3:"squircle"}]})])],64)}}},I=o(k,[["__file","/home/runner/work/daisyui-vue/daisyui-vue/docs/src/pages/components/mask.md"]]);export{I as default,C as meta};
