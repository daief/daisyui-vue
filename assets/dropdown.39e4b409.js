import{K as m,c as s,a5 as l,a as t,u as x,a7 as y,a8 as a,F as w,a9 as n,aa as q}from"./vendor.284b0716.js";var k={setup:()=>{const j=["top-start","top","top-end","bottom-start","bottom","bottom-end","left-start","left","left-end","right-start","right","right-end"],e=m(j[0]),o=m("btn"),c=r=>j.slice(r,r+3).map(p=>s(l("dv-button"),{key:p,size:"xs","data-pls":p,onClick:()=>e.value=p,type:p===e.value?"primary":"neutral"},{default:()=>[p]}));return()=>s("div",{class:"w-full"},[s("div",{class:"flex justify-center space-x-3 mb-1"},[s(l("dv-button"),{onClick:()=>o.value="btn"},{default:()=>[t("button")]}),s(l("dv-button"),{onClick:()=>o.value="div"},{default:()=>[t("div")]})]),s(l("dv-divider"),null,null),s("div",{class:"h-80 relative flex items-center justify-center"},[s(l("dv-dropdown"),{content:()=>s(l("dv-menu"),{class:"shadow-lg rounded-lg bg-base-100 p-1 w-40"},{default:()=>[s(l("dv-menu-item"),null,{default:()=>[t("Item 1")]}),s(l("dv-menu-item"),null,{default:()=>[t("Item 2")]})]}),open:!0,placement:e.value},{default:()=>[o.value==="btn"?s(l("dv-button"),{size:"sm"},{default:()=>[t("button")]}):s("div",{class:"w-8 h-8 flex items-center justify-center bg-red-400"},[t("div")])]}),s("div",{class:"absolute top-0 w-full flex justify-center space-x-2"},[c(0)]),s("div",{class:"absolute right-0 h-full flex flex-col justify-center space-y-2"},[c(9)]),s("div",{class:"absolute bottom-0 w-full flex justify-center space-x-2"},[c(3)]),s("div",{class:"absolute left-0 h-full flex flex-col justify-center space-y-2"},[c(6)])])])}};const C=n("div",{class:"markdown-body"},[n("h1",null,"Dropdown"),n("h2",null,"Examples"),n("p",null,"Dropdown menu")],-1),I={class:"text-center"},T=t("Click"),A=t("Item 1"),H=t("Item 2"),S=n("div",{class:"markdown-body"},[n("p",null,"Hover")],-1),z={class:"text-center"},D=t("Hover"),B=t("Item 1"),K=t("Item 2"),N=n("div",{class:"markdown-body"},[n("p",null,"placement")],-1),P=n("div",{class:"markdown-body"},[n("p",null,"Dropdown card")],-1),V={class:"text-center"},E=t("Hover"),F=t("Card Title"),G=n("p",null," you can use any element as a dropdown. ",-1),J=n("div",{class:"markdown-body"},[n("h2",null,"Dropdown"),n("h3",null,"Attributes"),n("p",null,[t("Attributes are same as "),n("code",null,"Popper"),t(".")])],-1),M=[],O={setup(j,{expose:e}){return e({frontmatter:{meta:[]}}),x({meta:[]}),(r,p)=>{const g=l("dv-button"),h=l("dv-menu-item"),i=l("dv-menu"),u=l("dv-dropdown"),d=l("Playground"),v=k,f=l("dv-card-title"),_=l("dv-card-body"),b=l("dv-card");return q(),y(w,null,[C,s(d,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text-center&quot;</span>&gt;</span>
...
`},{default:a(()=>[n("div",I,[s(u,{triggerAction:"click"},{content:a(()=>[s(i,{class:"shadow-lg rounded-lg bg-base-100 p-2 w-56"},{default:a(()=>[s(h,null,{default:a(()=>[A]),_:1}),s(h,null,{default:a(()=>[H]),_:1})]),_:1})]),default:a(()=>[s(g,null,{default:a(()=>[T]),_:1})]),_:1})])]),_:1}),S,s(d,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text-center&quot;</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-dropdown</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:a(()=>[n("div",z,[s(u,{triggerAction:"hover"},{content:a(()=>[s(i,{class:"shadow-lg rounded-lg bg-base-100 p-2 w-56"},{default:a(()=>[s(h,null,{default:a(()=>[B]),_:1}),s(h,null,{default:a(()=>[K]),_:1})]),_:1})]),default:a(()=>[s(g,null,{default:a(()=>[D]),_:1})]),_:1})])]),_:1}),N,s(d,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:a(()=>[s(v)]),_:1}),P,s(d,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text-center&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-dropdown</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">dv-button</span>&gt;</span>Hover<span class="hljs-tag">&lt;/<span class="hljs-name">dv-button</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> #<span class="hljs-attr">content</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-dropdown</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:a(()=>[n("div",V,[s(u,null,{content:a(()=>[s(b,{bordered:"",class:"w-64 bg-base-100"},{default:a(()=>[s(_,null,{default:a(()=>[s(f,null,{default:a(()=>[F]),_:1}),G]),_:1})]),_:1})]),default:a(()=>[s(g,null,{default:a(()=>[E]),_:1})]),_:1})])]),_:1}),J],64)}}};export{O as default,M as meta};
