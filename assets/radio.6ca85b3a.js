import{w as d,c as s,a2 as t,q as i,i as m,a as u,u as y,a4 as _,a5 as c,a6 as a,a7 as f}from"./vendor.5032f317.js";var w={setup:()=>{const l=d(),n=p=>{l.value=p.target.value};return()=>s(i,null,[s(t("dv-radio"),{checked:l.value==="a",onChange:n,name:"radio-2",value:"a"},null),s(t("dv-radio"),{checked:l.value==="b",onChange:n,name:"radio-2",value:"b"},null)])}};function b(l){return typeof l=="function"||Object.prototype.toString.call(l)==="[object Object]"&&!m(l)}var k={setup:()=>{const l=["neutral","primary","secondary","accent"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[l.map(n=>s("div",{key:n,class:"w-32"},[s(t("dv-radio"),{type:n},b(n)?n:{default:()=>[n]})]))])}},q={setup:()=>{const l=["xs","sm","md","lg"];return()=>s("div",{class:"flex flex-col items-center space-y-4"},[l.map(n=>s("div",{key:n},[s(t("dv-radio"),{size:n},null)]))])}},C={setup:()=>{const l=[{value:"apple",label:"Apple"},{value:"pear",label:"Pear"},{value:"orange",label:"Orange"}],n=d("apple"),p=d(!1);return()=>s("div",null,[s("div",{class:"flex items-center"},[s("label",{class:"mr-4"},[u("Disabled:")]),s(t("dv-toggle"),{checked:p.value,onChange:o=>p.value=o.target.checked},null)]),s(t("dv-divider"),null,null),s(t("dv-radio-group"),{size:"lg",options:l,disabled:p.value,modelValue:n.value,"onUpdate:modelValue":o=>n.value=o},null)])}};const z=a("div",{class:"markdown-body"},[a("h1",null,"Radio"),a("h2",null,"Examples"),a("p",null,"Radio")],-1),I=u(),S=a("div",{class:"markdown-body"},[a("p",null,"value & change")],-1),V=a("div",{class:"markdown-body"},[a("p",null,"Color type")],-1),O=a("div",{class:"markdown-body"},[a("p",null,"Sizes")],-1),T=a("div",{class:"markdown-body"},[a("p",null,"Group")],-1),A={class:"markdown-body"},N=a("h2",null,"Radio",-1),P=a("h3",null,"Attributes",-1),R=a("h2",null,"RadioGroup",-1),B=a("h3",null,"Attributes",-1),D=a("h2",null,"CSS variables",-1),F=[],H={setup(l,{expose:n}){return n({frontmatter:{meta:[]}}),y({meta:[]}),(E,G)=>{const h=t("dv-radio"),e=t("Playground"),j=w,g=k,x=q,v=C,r=t("MarkdownTable");return f(),_(i,null,[z,s(e,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-radio</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;radio-1&quot;</span> /&gt;</span> <span class="hljs-tag">&lt;<span class="hljs-name">dv-radio</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;radio-1&quot;</span> /&gt;</span>
`},{default:c(()=>[s(h,{name:"radio-1"}),I,s(h,{name:"radio-1"})]),_:1}),S,s(e,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:c(()=>[s(j)]),_:1}),V,s(e,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
...
`},{default:c(()=>[s(g)]),_:1}),O,s(e,{lang:"tsx",code:`<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-attr">setup</span>: <span class="hljs-function">() =&gt;</span> {
...
`},{default:c(()=>[s(x)]),_:1}),T,s(e,{lang:"tsx",code:`<span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
`},{default:c(()=>[s(v)]),_:1}),a("div",A,[N,P,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"size","1":"size","2":"ISize","3":"md"},{"0":"type","1":"color type","2":"neutral, primary, secondary, accent","3":"neutral"},{"0":"disabled","1":"disable status","2":"bool","3":"-"},{"0":"checked","1":"checked status","2":"bool","3":"-"},{"0":"value","1":"input value","2":"IText","3":"-"},{"0":"name","1":"input name","2":"string","3":"-"},{"0":"readOnly","1":"read only status","2":"bool","3":"-"}]}),R,B,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"size","1":"size","2":"ISize","3":"md"},{"0":"type","1":"color type","2":"neutral, primary, secondary, accent","3":"neutral"},{"0":"disabled","1":"disable status","2":"bool","3":"-"},{"0":"options","1":"options","2":"IOption[]","3":"-"},{"0":"v-model","1":"v-model for selected value","2":"IText","3":"-"},{"0":"defaultValue","1":"initial value","2":"IText","3":"-"}]}),D,s(r,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"default",dataIndex:2}],dataSource:[{"0":"--dv-radio-gap","1":"checkbox horizontal gap","2":"8px"}]})])],64)}}};export{H as default,F as meta};
