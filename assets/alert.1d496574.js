...
`},{default:a(()=>[s(l,{type:"error"},{default:a(()=>[I]),_:1})]),_:1}),k,s(e,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-alert</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;error&quot;</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-alert</span>&gt;</span>
`},{default:a(()=>[s(l,{type:"error"},{default:a(()=>[A]),actions:a(()=>[s(o,{type:"ghost",size:"sm",class:"mr-2"},{default:a(()=>[B]),_:1}),s(o,{type:"primary",size:"sm"},{default:a(()=>[C]),_:1})]),_:1})]),_:1}),N,s(e,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">dv-alert</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dv-alert</span>&gt;</span>
`},{default:a(()=>[s(l,null,{icon:a(()=>[s(i,{color:"#ef3636"})]),default:a(()=>[S]),content:a(()=>[T]),actions:a(()=>[s(o,{type:"ghost",size:"sm",class:"mr-2"},{default:a(()=>[s(d,{size:"1.5em"})]),_:1})]),_:1})]),_:1}),V,E,s(c,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"type","1":"alert color type","2":"info, success, warning, error","3":"-"}]}),M,s(c,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1}],dataSource:[{"0":"default","1":"alert title"},{"0":"content","1":"alert content"},{"0":"actions","1":"alert actions"}]})])}}};export{K as default};
