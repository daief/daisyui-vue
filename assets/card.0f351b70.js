import{u as j,a0 as l,a2 as m,c as s,a3 as t,a4 as a,p as _,a5 as v,a as n}from"./vendor.41784413.js";const b=a("div",{class:"markdown-body"},[a("h1",null,"Card"),a("h2",null,"Examples"),a("p",null,"card")],-1),q={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"},f=n("More info"),y=n(" Image bottom "),x=a("p",null," Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente. ",-1),S=n("Login"),w=n("Register"),I=n(" Small image file "),R=a("p",null," Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente. ",-1),k=n("Article"),M=n("Photography"),A=a("div",{class:"markdown-body"},[a("p",null,"image-full")],-1),C={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"},T=n("More info"),N=a("div",{class:"markdown-body"},[a("p",null,"card-compact")],-1),B={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"},G=n("More info"),P=a("div",{class:"markdown-body"},[a("p",null,"card with side image")],-1),H=n("More info"),V=a("div",{class:"markdown-body"},[a("p",null,"card without image")],-1),z=n("More info"),E=a("div",{class:"markdown-body"},[a("p",null,"glass card")],-1),F={class:"flex items-center w-full px-4 py-10 bg-cover text-white rounded-lg",style:{"background-image":"url(https://placeimg.com/400/225/arch)"}},L=a("img",{class:"rounded-2xl",src:"https://placeimg.com/400/225/arch"},null,-1),D=n(" Glass "),J=a("p",null," Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente. ",-1),K=n("More info"),O={class:"markdown-body"},Q=a("h2",null,"Card",-1),U=a("h3",null,"Attributes",-1),W=a("h3",null,"Slots",-1),X=a("h2",null,"CardImage",-1),Y=a("h3",null,"Attributes",-1),Z=a("h2",null,"CardBody",-1),$=a("h3",null,"Attributes",-1),ss=a("p",null,[a("code",null,"-")],-1),as=a("h2",null,"CardTitle",-1),ts=a("h3",null,"Attributes",-1),ns=a("h2",null,"CardActions",-1),ls=a("h3",null,"Attributes",-1),es=a("p",null,[a("code",null,"-")],-1),hs=[],us={setup(ps,{expose:g}){return g({frontmatter:{meta:[]}}),j({meta:[]}),(os,rs)=>{const e=l("dv-button"),p=l("dv-card"),o=l("dv-card-title"),r=l("dv-card-actions"),d=l("dv-card-body"),h=l("dv-card-image"),u=l("dv-badge"),c=l("Playground"),i=l("MarkdownTable");return v(),m(_,null,[b,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6&quot;</span>&gt;</span>
...
`},{default:t(()=>[a("div",q,[s(p,{class:"bg-base-100",bordered:"",image:"https://placeimg.com/400/225/arch",title:"Top image",description:"Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente."},{actions:t(()=>[s(e,{type:"secondary"},{default:t(()=>[f]),_:1})]),_:1}),s(p,{bordered:"",class:"bg-base-100"},{default:t(()=>[s(d,null,{default:t(()=>[s(o,null,{default:t(()=>[y]),_:1}),x,s(r,null,{default:t(()=>[s(e,{type:"primary"},{default:t(()=>[S]),_:1}),s(e,{type:"ghost"},{default:t(()=>[w]),_:1})]),_:1})]),_:1}),s(h,{src:"https://placeimg.com/400/225/arch"})]),_:1}),s(p,{bordered:"",class:"bg-base-100"},{default:t(()=>[s(h,{src:"https://placeimg.com/400/225/arch"}),s(d,null,{default:t(()=>[s(o,null,{default:t(()=>[I]),_:1}),R,s(r,null,{default:t(()=>[s(u,{type:"ghost"},{default:t(()=>[k]),_:1}),s(u,{type:"ghost"},{default:t(()=>[M]),_:1})]),_:1})]),_:1})]),_:1})])]),_:1}),A,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-card</span>
    <span class="hljs-attr">bordered</span>
    <span class="hljs-attr">image</span>=<span class="hljs-string">&quot;https://placeimg.com/400/225/arch&quot;</span>
 ...
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.&quot;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-card</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[a("div",C,[s(p,{bordered:"",image:"https://placeimg.com/400/225/arch",title:"Image overlay",description:`Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.`,"image-full":""},{actions:t(()=>[s(e,{type:"secondary"},{default:t(()=>[T]),_:1})]),_:1})])]),_:1}),N,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-card</span>
    <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;bg-base-100&quot;</span>
    <span class="hljs-attr">bordered</span>
    <span class="hljs-attr">image</span>=<span class="hljs-string">&quot;https://placeimg.com/400/225/arch&quot;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-card</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[a("div",B,[s(p,{class:"bg-base-100",bordered:"",image:"https://placeimg.com/400/225/arch",title:"This card is compact",description:"Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.",compact:""},{actions:t(()=>[s(e,{type:"secondary"},{default:t(()=>[G]),_:1})]),_:1})])]),_:1}),P,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-card</span>
    <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;bg-base-100&quot;</span>
    <span class="hljs-attr">bordered</span>
    <span class="hljs-attr">image</span>=<span class="hljs-string">&quot;https://placeimg.com/400/225/arch&quot;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-card</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[a("div",null,[s(p,{class:"bg-base-100",bordered:"",image:"https://placeimg.com/400/225/arch",title:"Horizontal",description:"Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.",side:""},{actions:t(()=>[s(e,{type:"secondary"},{default:t(()=>[H]),_:1})]),_:1})])]),_:1}),V,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">dv-card</span>
    <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;bg-base-100&quot;</span>
    <span class="hljs-attr">bordered</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-card</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[a("div",null,[s(p,{class:"bg-base-100",bordered:"",title:"No Images",description:"Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente."},{actions:t(()=>[s(e,{type:"secondary"},{default:t(()=>[z]),_:1})]),_:1})])]),_:1}),E,s(c,{code:`<span class="hljs-tag">&lt;<span class="hljs-name">div</span>
...
&gt;</span>
 ...
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.&quot;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">dv-card</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`},{default:t(()=>[a("div",F,[s(p,{bordered:"",glass:"",side:"",image:"https://placeimg.com/400/225/arch",title:"Glass",description:`Rerum reiciendis beatae tenetur excepturi aut pariatur est eos. Sit sit
 necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.`},{default:t(()=>[s(h,{class:"p-6"},{default:t(()=>[L]),_:1}),s(d,null,{default:t(()=>[s(o,null,{default:t(()=>[D]),_:1}),J,s(r,null,{default:t(()=>[s(e,{type:"glass"},{default:t(()=>[K]),_:1})]),_:1})]),_:1})]),_:1})])]),_:1}),a("div",O,[Q,U,s(i,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"bordered","1":"adds border to card","2":"boolean","3":"true"},{"0":"side","1":"the image in figure will be on to the side","2":"boolean","3":"false"},{"0":"imageFull","1":"the image in figure element will be the background","2":"boolean","3":"false"},{"0":"compact","1":"applies smaller padding","2":"boolean","3":"false"},{"0":"glass","1":"applies glass style","2":"boolean","3":"false"},{"0":"image","1":"image url of card (works when no default solt)","2":"string","3":"-"},{"0":"title","1":"title of card (works when no default solt)","2":"string","3":"-"},{"0":"description","1":"description of card (works when no default solt)","2":"string","3":"-"}]},null,8,["dataSource"]),W,s(i,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1}],dataSource:[{"0":"default","1":"card content"},{"0":"actions","1":"card actions(this works only when slots.default is undefined)"}]},null,8,["dataSource"]),X,Y,s(i,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"src","1":"image url of card","2":"string","3":"-"}]}),Z,$,ss,as,ts,s(i,{columns:[{title:"name",dataIndex:0},{title:"description",dataIndex:1},{title:"type",dataIndex:2},{title:"default",dataIndex:3}],dataSource:[{"0":"component","1":"the rendered element of title","2":"string","3":"h2"}]}),ns,ls,es])],64)}}};export{us as default,hs as meta};
